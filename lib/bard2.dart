...
void main() => runApp(const Bard2());

class Bard2 extends StatelessWidget {
  const Bard2({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('2nd Widget is Stateful, gets data from Parent'), // This will not update automatically
